window.Warmup = {
  ...
  initialize: function () {
    ...
    */
    showNamesForSelector("#under-isaiah-button", "#root:not(:first-child) > li:not(:nth-child(2)) > ul > li span");

    /*
      Description: show the names of the people under Eulalia
      Outcome: Claude, Lowell
    */
    showNamesForSelector("#under-eulalia-button", "#root > li:not(:first-child) > ul > li span");
